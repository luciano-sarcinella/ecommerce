        ...
        <section className="py-5">
          ...
          <div className="row">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="product text-center">
                <div className="position-relative mb-3">
                  <div className="badge text-white bg-"></div><a className="d-block" href="detail.html"><img class="img-fluid w-100" src={Producto1} alt="..."/></a>
                  <div className="product-overlay">
                    <ul className="mb-0 list-inline">
                      ...
                      <li className="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark rounded-0" href="cart.html">Comprar</a></li>
                      <li className="list-inline-item me-0"><a class="btn btn-sm btn-outline-dark rounded-0" href="#productView" data-bs-toggle="modal"><FontAwesomeIcon icon={faExpand}/></a></li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="product text-center">
                <div className="position-relative mb-3">
                  <div className="badge text-white bg-primary rounded-0">Sale</div><a className="d-block" href="detail.html"><img class="img-fluid w-100" src={Producto2} alt="..."/></a>
                  <div className="product-overlay">
                    <ul className="mb-0 list-inline">
                      <li className="list-inline-item m-0 p-0"><a className="btn btn-sm btn-outline-dark rounded-0" href="#!"><FontAwesomeIcon icon={faHeart}/></a></li>
                      <li className="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark rounded-0" href="cart.html">Comprar</a></li>
