  ...
  let content = <>
    <div className="product text-center">
      <div className="position-relative mb-3">
        <Link className="d-block" to={`/detail/${id}`}><img className="img-fluid w-100" src={`/images/${id}.png`} alt={titulo}/></Link>
      ...
      <h6> <Link className="reset-anchor" to={`/detail/${id}`}>{titulo}</Link></h6>
